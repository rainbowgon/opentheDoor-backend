...
@AllArgsConstructor
@Builder
public class WaitingNotificationOutDto {
    ...
    public static WaitingNotificationOutDto success(String memberId, String fcmToken, String title,
                                                    Reservation reservation) {
        return WaitingNotificationOutDto.builder()
                .memberId(memberId)
                .fcmToken(fcmToken)
