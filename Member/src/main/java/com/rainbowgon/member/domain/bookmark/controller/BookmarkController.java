...
public class BookmarkController {
    ...
    public ResponseEntity<ResponseWrapper<BookmarkSimpleResDto>> selectSimpleBookmarkList(
        ...
        BookmarkSimpleResDto bookmarkSimpleResDto = bookmarkService.selectSimpleBookmarkList(UUID.fromString(memberId));
    ...
    public ResponseEntity<ResponseWrapper<BookmarkDetailResDto>> selectDetailBookmarkList(
        ...
        BookmarkDetailResDto bookmarkDetailResDto = bookmarkService.selectDetailBookmarkList(UUID.fromString(memberId));
